...
function Faq() {
  return (
    <section className="px-[2vw] sm:px-[4vw] md:px-[6vw] py-2 sm:mx-auto sm:max-w-3xl sm:rounded-lg my-12">

      <div className="">

        <div className="flex flex-col items-center">
          <Title text1="Frequently" text2="Asked Questions" line={true} />
          <p className="mt-8">If you have any questions, please feel free to contact us.</p>
        </div>

        <div className="mx-auto mt-8 grid divide-y divide-black/20 shadow-md px-4 sm:px-8 rounded-md">
          <div className="py-5">
            <details className="group">
              ...
              <p className="group-open:animate-fadeIn mt-3">Springerdata offers a variety of
          ...
          <div className="py-5">
            <details className="group">
              ...
              <p className="group-open:animate-fadeIn mt-3">We offer a 30-day money-back
          ...
          <div className="py-5">
            <details className="group">
              ...
              <p className="group-open:animate-fadeIn mt-3">To cancel your subscription, you can
          ...
          <div className="py-5">
            <details className="group">
              ...
              <p className="group-open:animate-fadeIn mt-3">We offer a free trial of our software
          ...
          <div className="py-5">
            <details className="group">
              ...
              <p className="group-open:animate-fadeIn mt-3">If you need help with our platform or
          ...
          <div className="py-5">
            <details className="group">
              ...
              <p className="group-open:animate-fadeIn mt-3">We may offer discounts or promotions
        ...
        <p className='text-center mt-8'>Still have questions? <Link className='text-primary' to="/contact">Get in touch</Link></p>
      </div>
    </section>
  )
}
