...
function ProductCard({ id, images, name, price, sale }) {
  ...
  return (
    <Link to={`/product/${id}`} className='group block bg-white border border-gray-200 rounded-md overflow-hidden shadow-sm'>
        ...
        <div className="p-4">
          ...
          <div className='flex items-center justify-between mt-2'>
            <h1 className='text-xl font-semibold'>
              <span className='text-sm'>{currencySymbol} </span>{price}
            </h1>
            {sale && (
