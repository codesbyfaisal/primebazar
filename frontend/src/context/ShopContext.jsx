...
const ShopContextProvider = (props) => {
  ...
  const value = { products, getProductsData, getUserData, isLoading, currencySymbol, deliveryFee, cartTotalPrice, updateAddToCart, cartItems, blogs, backendUrl, isAuthenticated, deleteCartItem, getCartData,setCartItems };
